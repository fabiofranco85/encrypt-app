...
enum CryptoError: Error, Equatable {
    ...
    /// not parseable as a Hushbox container.
    ...
    var userMessage: String {
        switch self {
        case .malformedArtifact:
            return "This doesn’t look like a Hushbox message or file."
        case .unsupportedVersion:
            return "This was made with a newer version of Hushbox. Please update."
        case .unsupportedAlgorithm:
